...
class SettingController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        $defaultSettings = [
            ...
            'smtp_encryption' => ['value' => 'tls', 'type' => 'smtp'],
            'email_driver' => ['value' => 'smtp', 'type' => 'app'],
            'outlook_client_id' => ['value' => '', 'type' => 'outlook'],
            'outlook_client_secret' => ['value' => '', 'type' => 'outlook'],
            'outlook_redirect_uri' => ['value' => '', 'type' => 'outlook'],
            'outlook_tenant_id' => ['value' => 'common', 'type' => 'outlook'],
            'outlook_authorized' => ['value' => '0', 'type' => 'outlook'],
