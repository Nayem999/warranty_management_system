...
class ClaimResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'wo_assigned_date' => $this->wo_assigned_date?->format('d-M-Y h:i A'),
            'wo_closed_date' => $this->wo_closed_date?->format('d-M-Y h:i A'),
            'wo_delivery_date' => $this->wo_delivery_date?->format('d-M-Y h:i A'),
            'tat' => $this->tat,
            'doa' => $this->doa,
            ...
            'ref' => $this->ref,
            'web_wty_date' => $this->web_wty_date?->format('d-M-Y'),
